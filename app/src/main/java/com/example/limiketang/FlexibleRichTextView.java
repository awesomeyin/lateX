...
import static com.example.limiketang.Tokenizer.ATTACHMENT;
import static com.example.limiketang.Tokenizer.CENTER_START;
import static com.example.limiketang.Tokenizer.CODE_END;
import static com.example.limiketang.Tokenizer.CODE_START;
import static com.example.limiketang.Tokenizer.COLOR_START;
import static com.example.limiketang.Tokenizer.END;
import static com.example.limiketang.Tokenizer.FORMULA;
import static com.example.limiketang.Tokenizer.ICON;
import static com.example.limiketang.Tokenizer.PLAIN;
import static com.example.limiketang.Tokenizer.QUOTE_END;
import static com.example.limiketang.Tokenizer.QUOTE_START;
import static com.example.limiketang.Tokenizer.TABLE;
import static com.example.limiketang.Tokenizer.TOKEN;
import static com.example.limiketang.Tokenizer.URL_START;
import static com.example.limiketang.Tokenizer.tokenizer;
        ...
        while (!(thisToken() instanceof Tokenizer.END) && !(endClass.isInstance(thisToken()))) {
            ...
            if (!flag) {
                if (thisToken() instanceof PLAIN) {
                    ...
                    Tokenizer.FORMULA thisToken = (FORMULA) thisToken();
